...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header"><h4>Add New {{ucfirst($details )}}</h4></div>
            <form method="post" action="{{route('Information.store',['item'=>$Item->id])}}">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <input type="hidden" name="detailsName" value="{{$details}}">
                <div class="box-body">
                    <div id="text-group">
                        <div class="row">
                            <div class="col-md-11">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <a class="form-control btn btn-success" id="addRow"><i class="fa fa-fw fa-plus"></i>Add Text</a>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
